<template>
  <div
    class="fly-scroll-wrap"
    style="overflow: auto"
    :style="{ height: props.height || 'auto' }"
  >
    <slot name="content"> </slot>
    <div v-if="state.isLoading" class="fly-scroll-wrap-loading">
    ...
    <div v-if="!state.hasMore && props.isShowMore" class="fly-scroll-wrap-more">
